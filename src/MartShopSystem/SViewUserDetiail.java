 ...
 * @author user
 */
public class SViewUserDetiail extends javax.swing.JDialog {
    ...
    /**
     * Creates new form SViewUserDetiail
     */
    public SViewUserDetiail(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("View User Detail");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try{
        Statement s=DataCon.getDataCon().createStatement();
        ResultSet r=s.executeQuery("select usID,useradd,usUsername,usStatus,createDate from tbluserlogin");
        while(r.next()){
            String id=r.getString("usID");
            String name=r.getString("useradd");
            String username=r.getString("usUsername");
            String status=r.getString("usStatus");
            String cdate=r.getString("createDate");
            
            String st[]={id,name,username,status,cdate};
            table.addRow(st);
        }
        r.close();
        s.close();
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        try{
            ...
            ResultSet r=s.executeQuery("select * from tblproduct where usid like '"+search+"%' or proname like '"+search+"%'");
            if(r.first()){
                DefaultTableModel mod=(DefaultTableModel)table.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SViewUserDetiail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SViewUserDetiail dialog = new SViewUserDetiail(new javax.swing.JFrame(), true);
