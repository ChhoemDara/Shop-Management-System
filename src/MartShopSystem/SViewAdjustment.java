 ...
 * @author user
 */
public class SViewAdjustment extends javax.swing.JDialog {
    ...
    /**
     * Creates new form SViewAdjustment
     */
    public SViewAdjustment(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
            ...
            .addGroup(barHomeLayout.createSequentialGroup()
                ...
                .addGroup(barHomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(barHomeLayout.createSequentialGroup()
                        ...
                        .addGap(944, 944, Short.MAX_VALUE))
                    .addGroup(barHomeLayout.createSequentialGroup()
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Barcode", "Name", "Quality", "Status", "Date"
            }
        ) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try{
            ...
            ResultSet r=s.executeQuery("select barcode,proname,qty,status,createdate from tbladjust");
            while(r.next()){
                String barcode=r.getString("barcode");
                String name=r.getString("proname");
                String qty=r.getString("qty");
                String status=r.getString("status");
                String cdate=r.getString("createdate");
                
                String st[]={barcode,name,qty,status,cdate};
                table.addRow(st);
            }
            r.close();
            s.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SViewAdjustment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SViewAdjustment dialog = new SViewAdjustment(new javax.swing.JFrame(), true);
