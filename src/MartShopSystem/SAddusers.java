 ...
 * @author user
 */
public class SAddusers extends javax.swing.JDialog {
    ...
    /**
     * Creates new form SAdduser
     */
    public SAddusers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Full Name", "User Name", "Password", "Permissions", "Date"
            }
        ) {
            ...
            .addGroup(SSetingLayout.createSequentialGroup()
                ...
                .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(cboPermission, 0, 251, Short.MAX_VALUE)
    ...
    private void cmdCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCommitActionPerformed
        ...
        try{
            ...
            for(int i=0;i<table.getRowCount();i++){
                ...
                String permission=""+table.getValueAt(i, 3);
                String date=""+table.getValueAt(i, 4);
                s.execute("insert into tbluserlogin (useradd,usUsername,usPassword,usStatus,createDate) values "
                        + "('"+fullname+"','"+username+"','"+pass+"','"+permission+"','"+date+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SAddusers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SAddusers dialog = new SAddusers(new javax.swing.JFrame(), true);
