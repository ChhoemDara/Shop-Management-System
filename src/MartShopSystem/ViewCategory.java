...
public class ViewCategory extends javax.swing.JFrame {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        try{
            ...
            ResultSet r=s.executeQuery("select * from tblcategory where caid like '"+search+"%' or canameeng like '"+search+"%'");
            if(r.first()){
        ...
        if(!table.getSelectionModel().isSelectionEmpty()){
            ...
            try{
                ...
                for(int i=0;i<index.length;i++){
                    ...
                    s.execute("delete from tblcategory where caid="+id);
                }
                s.close();
                DefaultTableModel mod=(DefaultTableModel)table.getModel();
                for(int i=0;i<index.length;i++)
    ...
    private void callcategory()throws Exception{
        Statement s=DataCon.getDataCon().createStatement();
        ResultSet r=s.executeQuery("select cacode,canameeng,status,createdate from tblcategory");
        while(r.next()){
            String caCode=r.getString("cacode");
            String caNameEng=r.getString("canameeng");
            //String unit=
            String status=r.getString("status");
            String cdate=r.getString("createDate");
            
            String st[]={caCode,caNameEng,status,cdate};
            table.addRow(st);
        }
        r.close();
        s.close();
