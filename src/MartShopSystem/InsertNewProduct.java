 ...
 * @author user
 */
public class InsertNewProduct extends javax.swing.JFrame {
    ...
    /**
     * Creates new form InsertNewProduct
     */
    ...
    private void initComponents() {
        ...
        subJTextField6 = new subjtextfiledsk15.SubJTextField();
        ...
        subJTextField6.setBackground(new java.awt.Color(247, 247, 247));
        subJTextField6.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(204, 204, 204)));
        subJTextField6.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private void cmdMaxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdMaxActionPerformed
        try{
            if(maximized){
                InsertNewProduct.this.setExtendedState(JFrame.MAXIMIZED_BOTH);
                GraphicsEnvironment env=GraphicsEnvironment.getLocalGraphicsEnvironment();
                InsertNewProduct.this.setMaximizedBounds(env.getMaximumWindowBounds());
                maximized=false;
            }else{
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        try{
            if(MyInput.checkInput(txtCategoryID,txtBarcode,txtProName,txtSupplierName,txtQuality,txtUPriceIn,txtUPriceOut,txtDate,txtImagePro)){
                String cateID=txtCategoryID.getText();
                String barcode=txtBarcode.getText();
                String proName=txtProName.getText();
                String suname=txtSupplierName.getText();
                String qty=txtQuality.getText();
                String upriceIn=txtUPriceIn.getText();
                String upriceOut=txtUPriceOut.getText();
                String status=""+cboStatus.getSelectedItem();
                String cDate=txtDate.getText();
                String image=txtImagePro.getText();
                String st[]={cateID,barcode,proName,suname,qty,upriceIn,upriceOut,status,cDate,image};
                table.addRow(st);
                //txtProImage.setText("");
                lbImage.setIcon(null);
                MyInput.clearText(txtCategoryID,txtBarcode,txtProName,txtSupplierName,txtQuality,txtUPriceIn,txtUPriceOut,txtDate,txtImagePro);
    ...
    private void cmdCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCommitActionPerformed
        ...
        try{
            ...
            for(int i=0;i<table.getRowCount();i++){
                //String userId=""+table.getValueAt(i, 1);
                String cateID=""+table.getValueAt(i, 0);
                String barcode=""+table.getValueAt(i, 1);
                String proname=""+table.getValueAt(i, 2);
                String suname=""+table.getValueAt(i, 3);
                String qty=""+table.getValueAt(i, 4);
                String upriceIn=""+table.getValueAt(i, 5);
                String upriceOut=""+table.getValueAt(i, 6);
                String status=""+table.getValueAt(i, 7);
                String date=""+table.getValueAt(i, 8);
                String image=""+table.getValueAt(i, 9);//Image
                s.execute("insert into tblproduct "
                        + "(caID,barcode,proName,suppliername,qty,upriceIn,upriceOut,status,createDate,proimage) values "
                        + "('"+cateID+"','"+barcode+"','"+proname+"','"+suname+"',"+qty+","+upriceIn+","+upriceOut+","+status+",'"+date+"','"+image+"')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertNewProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertNewProduct().setVisible(true);
            }
        });
    }
    ...
    private subjtextfiledsk15.SubJTextField subJTextField6;
