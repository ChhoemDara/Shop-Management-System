...
public class Category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCategoryCode = new subjtextfiledsk15.SubJTextField();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        txtCategoryName = new subjtextfiledsk15.SubJTextField();
        ...
        txtUnit = new subjtextfiledsk15.SubJTextField();
        ...
        txtCategoryCode.setBackground(new java.awt.Color(247, 247, 247));
        txtCategoryCode.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(204, 204, 204)));
        txtCategoryCode.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        txtCategoryName.setBackground(new java.awt.Color(247, 247, 247));
        txtCategoryName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(204, 204, 204)));
        ...
        cboStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Action", "Disable" }));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Category Code", "Category Name", "Unit", "Status", "Date"
            }
        ) {
        ...
        txtUnit.setBackground(new java.awt.Color(247, 247, 247));
        txtUnit.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(204, 204, 204)));
            ...
            .addGroup(SSetingLayout.createSequentialGroup()
                ...
                .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(SSetingLayout.createSequentialGroup()
                        ...
                        .addGap(52, 52, 52)
                        .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtCategoryCode, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtCategoryName, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(txtUnit, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(173, 173, 173)
                .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(SSetingLayout.createSequentialGroup()
                        ...
                        .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(SSetingLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(txtCategoryCode, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        setSize(new java.awt.Dimension(1090, 532));
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        try{
            if(MyInput.checkInput(txtCategoryCode,txtCategoryName,txtUnit,txtDate)){
                String catecode=txtCategoryCode.getText();
                String catename=txtCategoryName.getText();
                String unit=txtUnit.getText();
                String status=""+cboStatus.getSelectedItem();
                String cDate=txtDate.getText();
                String st[]={catecode,catename,unit,status,cDate};
                table.addRow(st);
                MyInput.clearText(txtCategoryCode,txtUnit,txtCategoryName,txtDate);
                txtCategoryCode.grabFocus();
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, e);
        }
    ...
    private void cmdCommitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCommitActionPerformed
        ...
        try{
            ...
            for(int i=0;i<table.getRowCount();i++){
                String catecode=""+table.getValueAt(i, 0);
                String catename=""+table.getValueAt(i, 1);
                String catelogo=""+table.getValueAt(i, 2);
                String status=""+table.getValueAt(i, 3);
                String cdate=""+table.getValueAt(i, 4);
                
                s.execute("insert into tblcategory(caCode,caNameEng,caLogo,status,createDate)values"
                        + "('"+catecode+"','"+catename+"','"+catelogo+"','"+status+"','"+cdate+"')");
    ...
    private void cmdCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCancelActionPerformed
        try{
            MyInput.clearText(txtCategoryCode,txtCategoryName,txtUnit,txtDate);
            txtCategoryCode.grabFocus();
        }catch(Exception e){
            JOptionPane.showMessageDialog(this, e);
        }
    ...
    private subjtextfiledsk15.SubJTextField txtCategoryCode;
    private subjtextfiledsk15.SubJTextField txtCategoryName;
    private subjtextfiledsk15.SubJTextField txtDate;
    private subjtextfiledsk15.SubJTextField txtUnit;
